...
{
public:
    typedef std::function<std::shared_ptr<Entity> (SpritesSheet&, const sf::Vector2f&, const sf::Vector2f&)> FunctionPtrCreateEntity;
...
public:
    ...
    static std::shared_ptr<Entity> createUmbrellaBonus(SpritesSheet&, const sf::Vector2f& pos, const sf::Vector2f& size);
    static std::shared_ptr<Entity> createHandbagBonus(SpritesSheet&, const sf::Vector2f& pos, const sf::Vector2f& size);
